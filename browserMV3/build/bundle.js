...
var daiizGyazoDescLink = function daiizGyazoDescLink($appRoot, projectName) {
...
var daiizGyazoTextBubbleInit = function daiizGyazoTextBubbleInit($appRoot, targetSelector, projectName) {
  var timer = null;
...
exports.enable = function (projectName) {
  var $appRoot = $('body');
...
},{"../scrapbox-io/text-bubble.b.js":10,"jquery":1}],5:[function(require,module,exports){
'use strict';
...
},{"./gyazo-com/manage":3,"./gyazo-com/text-bubble":4,"./scrapbox-io/icon-button":6,"./scrapbox-io/manage":7,"./scrapbox-io/paste-webpage-url":8,"./scrapbox-io/rel-cards-bubble":9,"./scrapbox-io/text-bubble.b":10,"jquery":1}],6:[function(require,module,exports){
'use strict';

var $ = require('jquery');
var daiizScrapboxManage = require('./manage');
var installed = daiizScrapboxManage.installed;
var detectProject = daiizScrapboxManage.detectProject;
...
exports.enable = function () {
  ...
  $appRoot.on('click', 'img.icon', function (e) {
    ...
    if (iconName) {
      var scriptFilePath = location.origin + '/api/code/' + projectName + '/' + iconName[0] + '/button.js';
...
},{"./manage":7,"jquery":1}],7:[function(require,module,exports){
'use strict';
...
exports.detectProject = function () {
  var r = window.location.href.match(/scrapbox\.io\/([^/.]*)/) || window.location.href.match(/localhost\:\d+\/([^/.]*)/);
  if (r && r.length >= 2) return encodeURIComponent(r[1]);
  return 'daiiz';
};

var enableDaiizScript = function enableDaiizScript(pairs) {
  window.app.runtime.sendMessage({
...
var execPasteChrome = function execPasteChrome() {
...
var execPasteFirefox = async function execPasteFirefox() {
  // background scriptに処理を依頼できない
  // 拡張機能用のtextareaを生成してbody末尾に挿入
  var textarea = document.querySelector('#daiiz-ctrlv');
  if (!textarea) {
...
var insertTextToScrapboxCursor = function insertTextToScrapboxCursor(text) {
  ...
  if (isChrome()) {
    ...
    var start = textInput.selectionStart; // in this case maybe 0
...
exports.enable = function () {
  ...
  $(window).on('keydown', function (event) {
    var key = installed('daiiz-paste-url-title');
    if (!key) return;
...
},{"../browser":2,"./manage":7,"jquery":1}],9:[function(require,module,exports){
'use strict';
...
/* 関連カード */
var $getRelCardBubble = function $getRelCardBubble($appRoot) {
...
},{"./manage":7}],10:[function(require,module,exports){
'use strict';

var $ = require('jquery');
var daiizScrapboxManage = require('./manage');
var installed = daiizScrapboxManage.installed,
    detectProject = daiizScrapboxManage.detectProject;
...
var decorate = function decorate(str, strOpenMark, depth) {
  var html = '';
  var tagOpen = [];
  var tagClose = [];
...
var getScrapboxUrl = function getScrapboxUrl(url) {
  return 'https://scrapbox.io' + url;
};
exports.getScrapboxUrl = getScrapboxUrl;

var makePageLink = function makePageLink(body, tagOpen, tagClose) {
...
var makePair = function makePair(words) {
  var w0 = words[0];
...
var encodeHref = function encodeHref(url, startsWithHttp) {
...
// 画像になる可能性があるものに対処
var makeImageTag = function makeImageTag(keyword) {
...
/** Scrapboxの行単位での記法解析 */
var dicts = [];
var parse = function parse(fullStr, startIdx, depth, seekEnd) {
...
var parseRow = function parseRow(row) {
  ...
  for (var j = 0; j < res.length; j++) {
    var c = res.charAt(j);
    if (c === '<' && res.substring(j + 1, res.length).startsWith('script')) html += spans('<');else if (c === '<' && res.substring(j + 1, res.length).startsWith('/script')) html += spans('<');else if (c === ';') html += spans(';');else html += c;
  }
  return html;
};

var makeHashTagLinks = function makeHashTagLinks(row) {
  row = ' ' + row + ' ';
...
var makePlainLinks = function makePlainLinks(row) {
  row = ' ' + row + ' ';
  var words = row.split(' ');
  var res = [];
...
var makeShellStr = function makeShellStr(row) {
...
/*  表示コントール  */
/* ================ */
var previewPageText = function previewPageText($root, $bubble, title, rowHash) {
